...
public class ResourceGeneratorOverlay : MonoBehaviour
{
    ...
    private void Start()
    {
        ResourceGeneratorData resoruceGeneratorData = resourceGenerator.GetResourceGeneratorData();

        barTransform = transform.Find("bar");

        transform.Find("icon").GetComponent<SpriteRenderer>().sprite = resoruceGeneratorData.resourceType.sprite;
